    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 to-blue-900 bg-fixed p-4" 
      ...
      <div className="w-full max-w-xl rounded-3xl shadow-2xl backdrop-blur-lg p-10 border border-white/10"
        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-lg mx-auto">
          <div>
            <label className="block text-blue-200 font-medium mb-2 text-lg">Username</label>
            <input
              ...
              className="w-full px-5 py-4 bg-gray-800/50 border border-gray-700 text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-lg"
            />
          </div>

          <div>
            <div className="flex justify-between mb-2">
              <label className="text-blue-200 font-medium text-lg">Password</label>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`w-full py-4 rounded-xl font-semibold text-lg transition-all duration-200 relative overflow-hidden ${
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-400 text-lg">Don't have an account?</p>
          <button
            onClick={handleSignup}
            className="mt-2 text-blue-400 hover:text-blue-300 transition-colors font-medium text-lg"
          >
            Create an account
          </button>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-700">
          ...
          <div className="flex justify-center space-x-6">
            <button className="p-3 rounded-full bg-gray-800 hover:bg-gray-700 transition-colors">
              <svg className="w-7 h-7 text-gray-400" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
